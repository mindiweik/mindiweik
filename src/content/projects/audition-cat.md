...
I joined as the founding software engineer three years ago, and I have been here for every schema migration, every "wait, why did we build it that way", and every small win along the way.

It is a side project in the truest sense: built in the hours around a day job, at a pace that real life allows.
