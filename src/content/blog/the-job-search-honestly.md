...
**You are your own worst critic.** Out of all those interviews, maybe one or two actually felt like they went well. The rest ranged from "fine, I guess" to "I definitely just bombed that." And yet: two final rounds, one offer, one company asking to keep talking.
...
The system design rounds especially. You have to think out loud in a way that feels deeply unnatural, and the first few times it feels like performing expertise you're not sure you have. That's a skill you build by doing it badly a few times. Ask me how I know.
...
And there is always silence.

## what it revealed

Here is the part nobody posts about: the waiting.

The gap between interviews, between rounds, between the "we'll be in touch" and the actual touch. That's where the self-doubt lives. Not in the hard technical question. In the quiet Tuesday afternoon when you've heard nothing from anyone for four days. The antidote, for me, was keeping the pipeline moving so silence from one place couldn't consume all my mental space.
...
3. **What you actually want clarifies fast.** The first few processes helped define what mattered. By the end it was much cleaner: the kind of work, the kind of team, the kind of problem. Starting with that clarity would have made the early weeks faster.
