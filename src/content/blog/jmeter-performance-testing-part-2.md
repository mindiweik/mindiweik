...
One important thing I learned during this process is that it is possible to use the full URL in the path instead of setting the protocol, the server name/IP address, and identifying the “Advanced Implementation” setting [described here in Part 1.](/20-jmeter-performance-testing-part-1)
...
#### [JMeter Performance Testing: Part 1](/20-jmeter-performance-testing-part-1)
...
Then, we defined a plan for our performance testing. We had some example average data from a similar service. In [Part 1](/20-jmeter-performance-testing-part-1), we used 50,000 daily requests as an average for simplified math. We’ll continue to use this for consistency. 👍
...
Next, I used the setup options from [Part 1](/20-jmeter-performance-testing-part-1). Although it was a bit cumbersome, I created a file for each testing scenario. I did this for two reasons.
