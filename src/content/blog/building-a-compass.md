...
It's not just because AI is "here now." Though, of course, AI has a lot to do with this pace, bringing significant change in its wake. (Compare to my [first post on using AI](/04-how-to-start-working-with-ai) from barely 2 years ago! 🤯)
...
Have you noticed a trend on LinkedIn? Online in general? It's called burnout. Everyone is talking about it. I've been there. Done that. (See [previous post](/19-3-habits-that-helped-me-recover-from-burnout-and-stay-motivated).)
