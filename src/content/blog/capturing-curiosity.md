...
I took an ambiguous career path ([read more about that here](https://codeoutloud.substack.com/p/the-power-of-career-change)). For the first time a few years ago, I followed my personal curiosity, which morphed into my tech career! I’ve been rebuilding my “curiosity muscles” using tactics identified through my own research that can be practiced over time.
