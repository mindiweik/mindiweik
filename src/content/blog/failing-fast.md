...
That said, this concept is a [common Agile practice](http://We’ve all heard the phrase “fail fast,” especially if we’re familiar with the agile approach. As counter-intuitive as it might sound for those of us trained in the leadership model of the industrial era, iterating fast failures achieve a desired result faster than perfecting the solution.), better known as “iterations,” or attempts with adjustments. Experimentation and low-risk failures are encouraged for quicker, quality results. 
...
>
> [TechTarget.com post](https://www.techtarget.com/whatis/definition/fail-fast#:~:text=A%20fail%20fast%20mentality%20is,on%20to%20a%20better%20approach)
