# wip-podcast migration — review tracker

Check off each page as you approve it. Ordered oldest → newest (review order).

## 🎙️ Podcast episodes (16)

- [x] v0.0.0 — the first commit
- [x] v0.0.1 — david weiss
- [x] v0.0.2 — christin martin
- [x] v0.0.3 — brendan schirmer
- [x] v0.0.4 — colin j lacy
- [x] v0.0.5 — kim maida
- [x] v0.0.6 — nick clark
- [x] v0.0.7 — keshia coriolan
- [x] v0.0.8 — mara kaela
- [x] v0.0.9 — grace dees
- [x] v0.0.10 — joram mutenge
- [x] v1.0.0 — release notes
- [x] v1.0.1 — jaidie vargas
- [x] v1.0.2 — erik gross
- [x] v1.0.3 — anna miller
- [x] v1.0.4 — anemari fiser
...
talks + guest appearances all signed off (2026-07-01).
